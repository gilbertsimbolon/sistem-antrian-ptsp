...
Route::middleware('auth')->group(function () {
    ...
    // Daftar Antrian PTSP
    Route::get('/ptsp/daftar-antrian/ptsp', [DaftarAntrianController::class, 'showDaftarAntrian'])->name('daftar.antrian.index');
    Route::get('/ptsp/daftar-antrian/ptsp', [DaftarAntrianController::class, 'index'])->name('daftar.antrian.ptsp.index');
