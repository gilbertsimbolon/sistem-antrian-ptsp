...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <h1 class="text-center">Antrian Meja Pojok E-Court</h1>
            <div class="px-4 py-3" border-radius: 10px;">
                <table class="table table-bordered table-head-fixed" style="background-color: #e6f4ea;">
                    ...
                    <tbody>
                        @forelse ($antrianPojokECourt as $item)
                        <tr id="row-{{ $item->id }}">
                            <td>{{ $item->nama }}</td>
    ...
    <script>
        function panggil(nama, nomor, jenisKelamin, rowId) {
            ...
            const kalimat = `Atas nama ${sapaan} ${nama}, dengan nomor antrian ${nomor}, silakan menuju meja pojok ikort..`;
