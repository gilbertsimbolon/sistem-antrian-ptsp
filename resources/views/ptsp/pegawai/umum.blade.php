...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <h1 class="text-center">Antrian Meja Umum</h1>
    ...
    <script>
        function panggil(nama, nomor, jenisKelamin, rowId) {
            ...
            const kalimat = `Atas nama ${sapaan} ${nama}, dengan nomor antrian ${nomor}, silakan menuju meja umum..`;
