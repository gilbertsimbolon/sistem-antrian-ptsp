...
<head>
    ...
    <title>Meja Pojok E-Court | PN TONDANO</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="px-4" border-radius: 10px;">
                ...
                <table id="pojokECourtTable" class="table table-bordered table-head-fixed"
    ...
    <script>
        ...
        const table = $('#pojokECourtTable').DataTable({
            paging: false,
            dom: 'Bfrtip',
            buttons: [
                {
            ...
            initComplete: function() {
                ...
                $('#pojokECourtTable_filter').appendTo('#custom-search');
