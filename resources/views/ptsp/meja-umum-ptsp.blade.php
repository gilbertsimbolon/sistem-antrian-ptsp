...
<head>
    ...
    <title>Meja Umum | PN TONDANO</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="px-4" border-radius: 10px;">
                <h1 class="text-center">Buku Tamu Meja Umum</h1>
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div id="custom-export"></div>
                    <div id="custom-search" class="dataTables_filter"></div>
                </div>
                <table id="umumTable" class="table table-bordered table-head-fixed"
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">
                                <div class="d-flex gap-2">
                                    ...
                                    @include('ptsp.modal.edit-meja-umum')

                                    <!-- Form Hapus -->
                                    <form action="{{ route('umum.destroy', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
    ...
    <script>
        ...
        const table = $('#umumTable').DataTable({
            paging: false,
            dom: 'Bfrtip',
            buttons: [
                {
            ...
            initComplete: function() {
                ...
                $('#umumTable_filter').appendTo('#custom-search');
