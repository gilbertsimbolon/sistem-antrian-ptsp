...
<head>
    ...
    <title>Meja Inzage | PN TONDANO</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="px-4" border-radius: 10px;">
                ...
                <table id="inzageTable" class="table table-bordered table-head-fixed" style="background-color: #e6f4ea;">
                    <thead>
                        <tr>
                            <th>Nama</th>
                            <th>No Telepon</th>
    ...
    <script>
        ...
        const table = $('#inzageTable').DataTable({
            paging: false,
            dom: 'Bfrtip',
            buttons: [
                {
            ...
            initComplete: function() {
                ...
                $('#inzageTable_filter').appendTo('#custom-search');
