...
<head>
    ...
    <title>Meja Pidana | PN TONDANO</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="px-4" border-radius: 10px;">
                ...
                <table id="pidanaTable" class="table table-bordered table-head-fixed" style="background-color: #e6f4ea;">
                    <thead>
                        <tr>
                            <th>Nama</th>
                            <th>No Telepon</th>
    ...
    <script>
        ...
        const table = $('#pidanaTable').DataTable({
            paging: false,
            dom: 'Bfrtip',
            buttons: [
                {
            ...
            initComplete: function() {
                ...
                $('#pidanaTable_filter').appendTo('#custom-search');
